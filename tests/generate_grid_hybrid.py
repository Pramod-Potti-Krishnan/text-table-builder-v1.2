#!/usr/bin/env python3
"""
Generate Grid and Hybrid Templates for Review
"""
import sys
import os
import requests
...
GRID_HYBRID_VARIANTS = {
    "grid_2x3": "Grid 2×3 - 6 Content Boxes",
    "grid_3x2": "Grid 3×2 - 6 Content Boxes",
    "hybrid_top_2x2": "Hybrid Top 2×2 - Text Section + Grid",
    "hybrid_left_2x2": "Hybrid Left 2×2 - Sidebar + Grid"
}

def main():
    print("=" * 80)
    print("GRID & HYBRID TEMPLATES - Flash Model Only")
    print("=" * 80)
    ...
    for i, (variant_id, description) in enumerate(GRID_HYBRID_VARIANTS.items(), 1):
        print(f"\n[{i}/4] Generating: {variant_id}")

        slide_spec = {
            "slide_title": description,
            "slide_purpose": f"Visual review of {variant_id} layout",
            "key_message": "Grid and hybrid layout demonstration",
            "tone": "professional",
        ...
        try:
            ...
            slide = {
                ...
                "content": {
                    ...
                    "presentation_name": "Grid & Hybrid Templates Review",
                    "company_logo": ""
                }
            }
    ...
    presentation = {
        "title": "Grid & Hybrid Templates - Block by Block Review",
        "slides": slides
    }
    ...
    if response.status_code in [200, 201]:
        ...
        print("\n" + "=" * 80)
        print("✅ SUCCESS! Grid & Hybrid Templates Published")
        print("=" * 80)
        print(f"\n🌐 VIEW URL:")
        print(f"   {view_url}")
        print(f"\nGenerated: {len(slides)}/4 templates")
        print("\n" + "=" * 80)
    else:
